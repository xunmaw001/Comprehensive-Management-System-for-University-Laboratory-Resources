...
public class QingjiaController {
    ...
    */
    ...
    public R save(@RequestBody QingjiaEntity qingjia, HttpServletRequest request){
        ...
        Wrapper<QingjiaEntity> queryWrapper = new EntityWrapper<QingjiaEntity>()
            ...
            .eq("shenhe_types", qingjia.getShenheTypes())
    ...
    */
    ...
    public R shenheqingjia(Integer ids,Integer shenhe){
        QingjiaEntity qingjia = qingjiaService.selectById(ids);
        if(qingjia == null || shenhe == null){
            return R.error("请选择审核结果");
        }
        qingjia.setShenheTypes(shenhe);
        boolean b = qingjiaService.updateById(qingjia);
        if(b){
            return R.ok();
        }
        return R.error();
