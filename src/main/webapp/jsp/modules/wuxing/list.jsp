...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">无形资产管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">无形资产管理</li>
                            <li class="breadcrumb-item active">无形资产列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">无形资产列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="wuxingNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="资产名称" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //资产名称
            var wuxingNameSearchInput = $('#wuxingNameSearch');
            if( wuxingNameSearchInput != null){
                if (wuxingNameSearchInput.val() != null && wuxingNameSearchInput.val() != '') {
                    searchForm.wuxingName = $('#wuxingNameSearch').val();
                }
            }
        ...
        function getDataList() {
            http("wuxing/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                wuxingName: searchForm.wuxingName,
        ...
        function setDataRow(item, number) {
            ...
            //资产名称
            var wuxingNameCell = document.createElement('td');
            wuxingNameCell.innerHTML = item.wuxingName;
            row.appendChild(wuxingNameCell);


                //资产下载
            var wuxingFileCell = document.createElement('td');
            if(item.wuxingFile ==null || item.wuxingFile == '' || item.wuxingFile == 'null'){
                    wuxingFileCell.innerHTML = '没有下载文件';
            }else {
                var wuxingFileFile = document.createElement('button');
                    wuxingFileFile.innerHTML = '下载';
                var wuxingFileFileAttr = "download('" + item.wuxingFile + "')"
                    wuxingFileFile.setAttribute('onclick',wuxingFileFileAttr);
                    wuxingFileCell.appendChild(wuxingFileFile);
            }
            row.appendChild(wuxingFileCell);
        ...
        function shenhe() {
            ...
            if (mymessage == true) {
                http("wuxing/shenhe?shenhe="+$("#shenhe").val()+"&ids="+$("#ids").val(), "get", {}, (res) => {
                    if(res.code == 0)
                {
                    getDataList();
                    alert('操作成功');
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("wuxing/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addwuxing", "addwuxing");
            window.location.href = "add-or-update.jsp"
        }
