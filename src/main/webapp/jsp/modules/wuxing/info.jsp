            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">无形资产登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="wuxingName" name="wuxingName" class="form-control"
                                               v-model="ruleForm.wuxingName" readonly>
                                    </div>
...
<script>
    ...
    function setDownloadBtn() {
        var wuxingFileUrl = "download('" + ruleForm.wuxingFile + "')";
        $("#wuxingFile").attr("onclick", wuxingFileUrl);
