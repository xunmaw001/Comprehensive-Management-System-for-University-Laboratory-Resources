    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑无形资产</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑无形资产</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">无形资产信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>资产名称</label>
                                        <input id="wuxingName" name="wuxingName" class="form-control"
                                               placeholder="资产名称">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>资产下载</label>
                                        <input name="file" type="file" class="form-control-file" id="wuxingFileupload">
                                        <label id="wuxingFileName"></label>
                                        <input name="wuxingFile" id="wuxingFile-input" type="hidden">
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        $('#wuxingFileupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                document.getElementById('wuxingFile-input').setAttribute('value', baseUrl + 'file/download?fileName=' + data.result.file);
                document.getElementById('wuxingFileName').innerHTML = "上传成功!";
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("wuxing/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addwuxing');
    ...
    // 获取当前详情
    function getDetails() {
        var addwuxing = window.sessionStorage.getItem("addwuxing");
        if (addwuxing != null && addwuxing != "" && addwuxing != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("wuxing/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#wuxingName").val(ruleForm.wuxingName);
