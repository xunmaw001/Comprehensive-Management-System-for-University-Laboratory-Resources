    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑实验室活动</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">实验室活动管理</li>
                        <li class="breadcrumb-item active">编辑实验室活动</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">实验室活动信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>活动标题</label>
                                        <input id="huodongName" name="huodongName" class="form-control"
                                               placeholder="活动标题">
                                    </div>
                                <input id="jiaoshiId" name="jiaoshiId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>活动类型</label>
                                        <select id="huodongTypesSelect" name="huodongTypes" class="form-control">
                                        </select>
                                    </div>
